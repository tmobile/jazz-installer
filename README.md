...
```
curl -L https://raw.githubusercontent.com/tmobile/jazz-installer/v1.2/installscripts/terraforminstaller/rhel7Installer.sh -o rhel7Installer.sh && chmod +x rhel7Installer.sh && ./rhel7Installer.sh v1.2 && cd ./jazz-installer/installscripts/wizard && ./run.py 
 ```

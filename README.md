...
```
curl -L https://raw.githubusercontent.com/tmobile/jazz-installer/v1.1.2_fix/installscripts/terraforminstaller/rhel7Installer.sh -o rhel7Installer.sh && chmod +x rhel7Installer.sh && ./rhel7Installer.sh v1.1.2_fix && cd ./jazz-installer/installscripts/wizard && ./run.py 
 ```

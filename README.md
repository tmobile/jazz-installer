...
* Make sure that you have **Jenkins and Bitbucket** as Jenkins/Bitbucket URL and their public IPs must be provided as you proceed with the installation session.

...
default['jenkins']['SES-defaultSuffix']='defaultSuffix'
default['jenkins']['SES-smtpAuthUsername']='smtpAuthUsername'
default['jenkins']['SES-smtpAuthPassword']='smtpAuthPassword'

...
attrbsfile=$JAZZ_ROOT/installscripts/cookbooks/jenkins/attributes/default.rb
...
sed -i "s|replace|$token|g" $JAZZ_ROOT/installscripts/cookbooks/jenkins/files/credentials/gitlab-token.sh
...
jenkinsJsonfile=$JAZZ_ROOT/installscripts/cookbooks/jenkins/files/node/jazz-installer-vars.json

...
def check_jenkins_pem():
    ...
    print(" Please create jenkinskey.pem with private keys of Jenkins Server in your Jazz Install directory")
    pause()

    #Check if file is been added to home derectory
    if not os.path.isfile(JENKINS_PEM):
        sys.exit("File jenkinskey.pem is not present in your Jazz Install folder, kindly add and run the installer again! ")

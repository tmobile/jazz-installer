...
nodejs81_service=("jazz_email" "jazz_usermanagement" "jazz_codeq" "jazz_metrics" "jazz_slack-event-handler" "jazz_is-slack-channel-available" "jazz_admin" "jazz_slack-channel" "jazz_deployments-event-handler" "jazz_assets" "jazz_cognito-authorizer" "jazz_services-handler" "jazz_events-handler" "jazz_environment-event-handler" "jazz_asset-event-handler")
